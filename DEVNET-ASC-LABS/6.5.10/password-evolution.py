...
#binds the route (top level directory) of the webservice
#to the index function
#everytime a http get is received this function runs

@app.route('/')
def index():
    return 'Welcome to the hands-on lab for an evolution of password systems!'

#binds the app.run to the python main entry point
